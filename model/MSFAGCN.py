...
class AdaptiveGCN_Layer(nn.Module):
    def __init__(self, in_channels, hidden_size):
        super(AdaptiveGCN_Layer, self).__init__()
...
class MSFAGCN(nn.Module):
    ...
    def __init__(self, configs, in_channels, out_channels, down_sampling_layers, T_out):
        ...
        self.gcn_Layer = nn.ModuleList([
                AdaptiveGCN_Layer(in_channels, out_channels)
