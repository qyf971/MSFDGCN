...
class MSFGCN(nn.Module):

    def __init__(self, configs, in_channels, out_channels, down_sampling_layers, T_out, device, adj):
        super(MSFGCN, self).__init__()
        ...
        self.gcn_Layer = nn.ModuleList([
                GCN(device, adj, in_channels, out_channels)
